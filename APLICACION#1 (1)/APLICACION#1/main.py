...
def guardarRegistros():
     ...
     try:
         ...
         CClientes.ingresarClientes(rut, nombres, apellidos, telefono, correo, direccion, sexo)
...
def modificarRegistros():
     ...
     try:
         ...
         CClientes.modificarClientes(idUsuario, nombres, apellidos, sexo, telefono, correo, direccion)
